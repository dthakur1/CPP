...
main(int argc, char **argv) {
    ...
    if (do_mem_test) {
        ...
        struct rlimit limit;
        rv = getrlimit(RLIMIT_AS, &limit);
        assert(rv == 0);
        limit.rlim_cur = MEMORY_LIMIT;
        rv = setrlimit(RLIMIT_AS, &limit);
        assert(rv == 0);
    }
    ...
    // Test std::put_time().
    {
        ...
        std::cout << ss.str() << std::endl;
        // assert(ss.str() ==
        //        "Mon 02 May 2016 01:53:44 PM EDT EDT, Mon 02 May 2016 01:53:01 PM EDT +0000 Mon May  2 13:53:44 2016 EDT, Mon May  2 13:53:01 2016 +0000");
    }
